...
#ifndef CAINPLAYER_MEDIAMETADATARETRIEVER_H
#define CAINPLAYER_MEDIAMETADATARETRIEVER_H
...
private:
    ...
    // 初始化
    void initMetadataState(MetadataState **ps);
...
#endif //CAINPLAYER_MEDIAMETADATARETRIEVER_H
