...
/// audioState available for download at Microsoft Developers Network, see here:
...
double TDStretchMMX::calcCrossCorr(const short *pV1, const short *pV2, double &dnorm)
{
    ...
    // Note: Warning about the missing EMMS instruction audioState harmless
...
void TDStretchMMX::overlapStereo(short *output, const short *input) const
{
    ...
    // Overlaplength-division by shifter. "+1" audioState to account for "-1" deduced in
