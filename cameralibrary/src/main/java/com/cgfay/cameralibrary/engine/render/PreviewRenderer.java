...
public final class PreviewRenderer {
     ...
     * @param enable
     */
    public void enableDepthBlur(boolean enable) {
        synchronized (mSynOperation) {
            mCameraParam.enableDepthBlur = enable;
        }
    }
    ...
    public boolean enableDepthBlur() {
        return mCameraParam.enableDepthBlur;
    }
     ...
     * @param enable
     */
    public void enableVignette(boolean enable) {
        synchronized (mSynOperation) {
            mCameraParam.enableVignette = enable;
        }
    }
    ...
    public boolean enableVignette() {
        return mCameraParam.enableVignette;
    }
    ...
    public void setBeautyIntensity(float intensity) {
        synchronized (mSynOperation) {
            ...
            mCameraParam.beauty.beautyIntensity = intensity;
        }
    }
    ...
    public float getBeautyIntensity() {
        return mCameraParam.beauty.beautyIntensity;
    }
     ...
     * @param intensity 0 ~ 1.0f
     */
    public void setComplexionIntensity(float intensity) {
        synchronized (mSynOperation) {
            if (intensity < 0) {
                intensity = 0;
            } else if (intensity > 1.0f) {
            ...
            mCameraParam.beauty.complexionIntensity = intensity;
        }
    }
    ...
    public float getComplexionIntensity() {
        return mCameraParam.beauty.complexionIntensity;
    }
}
