...
public class GLImageRomanceFilter extends GLImageFilter {
    ...
    public GLImageRomanceFilter(Context context) {
        this(context, VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLImageRomanceFilter(Context context, String vertexShader, String fragmentShader) {
