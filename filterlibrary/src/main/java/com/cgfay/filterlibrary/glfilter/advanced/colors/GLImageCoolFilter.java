...
public class GLImageCoolFilter extends GLImageFilter {
    ...
    public GLImageCoolFilter(Context context) {
        this(context, VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLImageCoolFilter(Context context, String vertexShader, String fragmentShader) {
