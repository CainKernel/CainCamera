package com.cgfay.cainfilter.filter.color;
...
public class BlackCatFilter extends BaseImageFilter {
    ...
    public BlackCatFilter() {
        this(VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public BlackCatFilter(String vertexShader, String fragmentShader) {
