package com.cgfay.cainfilter.glfilter.advanced;
...
public class SketchFilter extends BaseImageFilter {
    ...
    public SketchFilter(String vertexShader, String fragmentShader) {
