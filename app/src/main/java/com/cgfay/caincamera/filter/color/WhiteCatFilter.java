package com.cgfay.caincamera.filter.color;
...
public class WhiteCatFilter extends BaseImageFilter {
    ...
    public WhiteCatFilter() {
        this(VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public WhiteCatFilter(String vertexShader, String fragmentShader) {
