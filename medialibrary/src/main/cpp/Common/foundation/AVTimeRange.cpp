...
const static AVTimeRange kAVTimeRangeZero = { kAVTimeZero, kAVTimeZero};

const static AVTimeRange kAVTimeRangeInvalid = { kAVTimeInvalid, kAVTimeInvalid};

const static AVTimeMapping kAVTimeMappingInvalid = { kAVTimeRangeInvalid, kAVTimeRangeInvalid};
