...
#ifndef CAVMEDIAPLAYER_H
#define CAVMEDIAPLAYER_H
 ...
 * 媒体播放器
 */
class CAVMediaPlayer : Runnable {
public:
    CAVMediaPlayer();

    virtual ~CAVMediaPlayer();
...
public:
    MediaPlayerListener(CAVMediaPlayer *player);
...
private:
    CAVMediaPlayer *player;
};


#endif //CAVMEDIAPLAYER_H
