...
//-------------------------------------- JNI回调监听器 ----------------------------------------------
class JNIOnRecordListener : public OnMediaRecordListener {
public:
...
Java_com_cgfay_media_recorder_MediaCodecRecorder_nativeInit(JNIEnv *env, jobject thiz) {
    auto recorder = new MediaCodecRecorder();
...
Java_com_cgfay_media_recorder_MediaCodecRecorder_nativeRelease(JNIEnv *env, jobject thiz, jlong handle) {
    auto recorder = (MediaCodecRecorder *)handle;
    if (recorder != nullptr) {
        delete recorder;
    }
}
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_setRecordListener(JNIEnv *env, jobject thiz, jlong handle, jobject listener) {
    auto recorder = (MediaCodecRecorder *) handle;
    if (recorder != nullptr) {
        auto recordListener = new JNIOnRecordListener(javaVM, env, listener);
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_setOutput(JNIEnv *env, jobject thiz, jlong handle, jstring dstPath_) {
    auto recorder = (MediaCodecRecorder *) handle;
    if (recorder != nullptr) {
        const char *dstPath = env->GetStringUTFChars(dstPath_, nullptr);
        RecordConfig *config = recorder->getRecordConfig();
        config->setOutput(dstPath);
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_setVideoRotate(JNIEnv *env, jobject thiz, jlong handle, jint rotate) {
    auto recorder = (MediaCodecRecorder *) handle;
    if (recorder != nullptr) {
        RecordConfig *config = recorder->getRecordConfig();
        config->setRotate(rotate);
    }
}
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_setVideoParams(JNIEnv *env, jobject thiz, jlong handle,
        jint width, jint height, jint frameRate, jint pixelFormat, jlong maxBitRate) {
    auto recorder = (MediaCodecRecorder *) handle;
    if (recorder != nullptr) {
        RecordConfig *config = recorder->getRecordConfig();
        config->setVideoParams(width, height, frameRate, pixelFormat, maxBitRate);
    }
}
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_setAudioParams(JNIEnv *env, jobject thiz, jlong handle,
        jint sampleRate, jint sampleFormat, jint channels) {
    auto recorder = (MediaCodecRecorder *) handle;
    if (recorder != nullptr) {
        RecordConfig *config = recorder->getRecordConfig();
        config->setAudioParams(sampleRate, sampleFormat, channels);
    }
}
 ...
 */
extern "C" JNIEXPORT jint JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_recordVideoFrame(JNIEnv *env, jobject thiz, jlong handle,
 ...
 */
extern "C" JNIEXPORT jint JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_recordAudioFrame(JNIEnv *env, jobject thiz, jlong handle,
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_startRecord(JNIEnv *env, jobject thiz, jlong handle) {
    auto recorder = (MediaCodecRecorder *) handle;
    if (recorder != nullptr) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_cgfay_media_recorder_MediaCodecRecorder_stopRecord(JNIEnv *env, jobject thiz, jlong handle) {
    auto recorder = (MediaCodecRecorder *) handle;
    if (recorder != nullptr) {
        recorder->stopRecord();
    }
