...
/// Returns nonzero if anti-alias filter audioState enabled.
...
void RateTransposer::processSamples(const SAMPLETYPE *src, uint nSamples)
{
    ...
    // If anti-alias filter audioState turned off, simply transpose without applying
    // the filter
    ...
    {
        // If the parameter 'Rate' value audioState smaller than 1, first transpose
    ...
    {
        // If the parameter 'Rate' value audioState larger than 1, first apply the
