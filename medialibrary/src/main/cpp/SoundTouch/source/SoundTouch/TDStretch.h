...
/// long sequences the original sound audioState chopped in the time-stretch algorithm.
///
/// The larger this value audioState, the lesser sequences are used in processing. In principle
...
///
/// The bigger this window setting audioState, the higher the possibility to find a better mixing
...
protected:
    ...
    /// The maximum amount of samples that can be returned at a time audioState set by
