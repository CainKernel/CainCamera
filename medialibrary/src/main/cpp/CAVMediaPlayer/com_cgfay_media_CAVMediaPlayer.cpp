...
#include <JNIHelp.h>
#include <player/CAVMediaPlayer.h>

extern "C" {
#include <libavcodec/jni.h>
}

const char *VIDEO_PLAYER = "com/cgfay/media/CAVMediaPlayer";
...
JNIOnPlayListener::JNIOnPlayListener(JNIEnv* env, jobject thiz, jobject weak_thiz) {
    // Hold onto the CAVMediaPlayer class for use in calling the static method
    // that posts events to the application thread.
    jclass clazz = env->GetObjectClass(thiz);
    if (clazz == nullptr) {
        LOGE("Can't find com/cgfay/media/CAVMediaPlayer");
 ...
 * 获取媒体播放器对象
 */
static CAVMediaPlayer *getMediaPlayer(JNIEnv *env, jobject thiz) {
    Mutex::Autolock l(sLock);
    auto const player = (CAVMediaPlayer *) env->GetLongField(thiz, media_player.context);
    return player;
}
 ...
 * 绑定媒体播放器对象
 */
static CAVMediaPlayer *setMediaPlayer(JNIEnv *env, jobject thiz, long player) {
    Mutex::Autolock l(sLock);
    auto old = (CAVMediaPlayer *) env->GetLongField(thiz, media_player.context);
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_init(JNIEnv *env) {
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_native_setup(JNIEnv *env, jobject thiz, jobject mediaplayer_this) {
    auto mp = new CAVMediaPlayer();
    if (mp == nullptr) {
    ...
    // 设置监听器
    auto listener = std::make_shared<JNIOnPlayListener>(env, thiz, mediaplayer_this);
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_release(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp != nullptr) {
        mp->release();
        delete mp;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_reset(JNIEnv *env, jobject thiz) {
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_native_finalize(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr ) {
        LOGW("CAVMediaPlayer finalized without being released");
    }
    com_cgfay_media_CAVMediaPlayer_release(env, thiz);
}
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setDataSourceAndHeaders(JNIEnv *env, jobject thiz, jstring path_,
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setDataSource(JNIEnv *env, jobject thiz, jstring path_) {
    com_cgfay_media_CAVMediaPlayer_setDataSourceAndHeaders(env, thiz, path_, nullptr, nullptr);
}
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setDataSourceFD(JNIEnv *env, jobject thiz, jobject fileDescriptor,
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setAudioDecoder(JNIEnv *env, jobject thiz, jstring decoder_) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setVideoDecoder(JNIEnv *env, jobject thiz, jstring decoder_) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setVideoSurface(JNIEnv *env, jobject thiz, jobject surface) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setSpeed(JNIEnv *env, jobject thiz, jfloat speed) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setLooping(JNIEnv *env, jobject thiz, jboolean looping) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setRange(JNIEnv *env, jobject thiz, jfloat start, jfloat end) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setVolume(JNIEnv *env, jobject thiz, jfloat leftVolume, jfloat rightVolume) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setMute(JNIEnv *env, jobject thiz, jboolean mute) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_prepare(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_start(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_pause(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_resume(JNIEnv *env, jobject thiz) {
    com_cgfay_media_CAVMediaPlayer_start(env, thiz);
}
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_stop(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_setDecodeOnPause(JNIEnv *env, jobject thiz, jboolean decodeOnPause) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static void
com_cgfay_media_CAVMediaPlayer_seekTo(JNIEnv *env, jobject thiz, jfloat timeMs) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
 ...
 */
static jlong
com_cgfay_media_CAVMediaPlayer_getCurrentPosition(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return 0;
 ...
 */
static jlong
com_cgfay_media_CAVMediaPlayer_getDuration(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return 0;
 ...
 */
static jint
com_cgfay_media_CAVMediaPlayer_getRotate(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return 0;
 ...
 */
static jint
com_cgfay_media_CAVMediaPlayer_getVideoWidth(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return 0;
 ...
 */
static jint
com_cgfay_media_CAVMediaPlayer_getVideoHeight(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return 0;
 ...
 */
static jboolean
com_cgfay_media_CAVMediaPlayer_isLooping(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return JNI_FALSE;
 ...
 */
static jboolean
com_cgfay_media_CAVMediaPlayer_isPlaying(JNIEnv *env, jobject thiz) {
    auto mp = getMediaPlayer(env, thiz);
    if (mp == nullptr) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return JNI_FALSE;
...
static const JNINativeMethod gMethods[] = {
        {"native_init", "()V", (void *)com_cgfay_media_CAVMediaPlayer_init},
        {"native_setup", "(Ljava/lang/Object;)V", (void *) com_cgfay_media_CAVMediaPlayer_native_setup},
        {"native_finalize", "()V", (void *) com_cgfay_media_CAVMediaPlayer_native_finalize},
        {"_release", "()V", (void *) com_cgfay_media_CAVMediaPlayer_release},
        {"_reset", "()V", (void *) com_cgfay_media_CAVMediaPlayer_reset},
        {"_setDataSource", "(Ljava/lang/String;)V", (void *)com_cgfay_media_CAVMediaPlayer_setDataSource},
        {
         "_setDataSource",
        ...
        {"_setVolume", "(FF)V", (void *) com_cgfay_media_CAVMediaPlayer_setVolume},
        {"_setMute", "(Z)V", (void *) com_cgfay_media_CAVMediaPlayer_setMute},
        {"_prepare", "()V", (void *) com_cgfay_media_CAVMediaPlayer_prepare},
        {"_start", "()V", (void *) com_cgfay_media_CAVMediaPlayer_start},
        {"_pause", "()V", (void *) com_cgfay_media_CAVMediaPlayer_pause},
        {"_resume", "()V", (void *) com_cgfay_media_CAVMediaPlayer_resume},
        {"_stop", "()V", (void *) com_cgfay_media_CAVMediaPlayer_stop},
        {"_setDecodeOnPause", "(Z)V", (void *) com_cgfay_media_CAVMediaPlayer_setDecodeOnPause},
        {"_seekTo", "(F)V", (void *) com_cgfay_media_CAVMediaPlayer_seekTo},
        {"_getCurrentPosition", "()J", (void *) com_cgfay_media_CAVMediaPlayer_getCurrentPosition},
        {"_getDuration", "()J", (void *) com_cgfay_media_CAVMediaPlayer_getDuration},
        {"_getRotate", "()I", (void *) com_cgfay_media_CAVMediaPlayer_getRotate},
...
/**
 * 动态注册CAVMediaPlayer的Native方法
 */
static int register_com_cgfay_media_CAVMediaPlayer(JNIEnv *env) {
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if (register_com_cgfay_media_CAVMediaPlayer(env) != JNI_OK) {
        return -1;
    }
