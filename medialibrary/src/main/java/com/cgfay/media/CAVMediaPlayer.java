 ...
 * 媒体播放器
 */
public class CAVMediaPlayer implements IMediaPlayer {

    private static final String TAG = "CAVMediaPlayer";

    static {
        System.loadLibrary("ffmpeg");
        System.loadLibrary("yuv");
        System.loadLibrary("cav_player");
        native_init();
    }
    ...
    public CAVMediaPlayer() {
         ...
         */
        native_setup(new WeakReference<CAVMediaPlayer>(this));
    }
     ...
     */
    public static CAVMediaPlayer create(Context context, Uri uri) {
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static CAVMediaPlayer create(Context context, Uri uri, SurfaceHolder holder) {

        try {
            CAVMediaPlayer mp = new CAVMediaPlayer();
     ...
     * @return a MediaPlayer object, or null if creation failed
     */
    public static CAVMediaPlayer create(Context context, int resid) {
        try {
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        mWakeLock = pm.newWakeLock(mode| PowerManager.ON_AFTER_RELEASE, CAVMediaPlayer.class.getName());
    ...
    private class EventHandler extends Handler {
        ...
        public EventHandler(CAVMediaPlayer mp, Looper looper) {
            super(looper);
            mMediaPlayer = mp;
        }
            ...
            switch (msg.what) {
                ...
                case MEDIA_VIDEO_CURRENT: {
                    if (mOnVideoPositionListener != null) {
                        mOnVideoPositionListener.onVideoPosition(mMediaPlayer, msg.arg1, msg.arg2);
                    }
                    break;
                }
     ...
     * We use a weak reference to the original CAVMediaPlayer object so that the native
     * code is safe from the object disappearing from underneath it.  (This is
     * the cookie passed to native_setup().)
     */
    private static void postEventFromNative(Object mediaplayer_ref,
                                            int what, int arg1, int arg2, Object obj) {
        final CAVMediaPlayer mp = (CAVMediaPlayer)((WeakReference) mediaplayer_ref).get();
        if (mp == null) {
            return;
        }
