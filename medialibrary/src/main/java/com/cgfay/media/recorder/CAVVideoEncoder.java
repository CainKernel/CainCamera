 ...
 * @date 2019/6/30
 */
final class CAVVideoEncoder {

    private static final String TAG = "CAVVideoEncoder";
     ...
     * 配置编码器和复用器等参数
     */
    public CAVVideoEncoder(@NonNull VideoParams params, OnEncodingListener listener) throws IOException {
        mVideoParams = params;
