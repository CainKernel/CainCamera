 ...
 * @date 2019/6/30
 */
final class JAVVideoEncoder {

    private static final String TAG = "AVVideoEncoder";
     ...
     * 配置编码器和复用器等参数
     */
    public JAVVideoEncoder(@NonNull VideoParams params, OnEncodingListener listener) throws IOException {
        mVideoParams = params;
