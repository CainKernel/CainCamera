 ...
 * @date 2019/6/30
 */
public class CAVMediaRecorder implements OnRecordListener {
    ...
    // 音频录制器
    private final CAVAudioRecorder mAudioRecorder;
    // 视频录制器
    private final CAVVideoRecorder mVideoRecorder;
    // 是否支持音频录制
    ...
    public CAVMediaRecorder(OnRecordStateListener listener) {
        mRecordStateListener = listener;
        mVideoRecorder = new CAVVideoRecorder();
        mVideoRecorder.setOnRecordListener(this);

        mAudioRecorder = new CAVAudioRecorder();
