 ...
 * @date 2019/6/30
 */
public final class JAVAudioRecorder implements Runnable {

    private int mBufferSize = JAVAudioEncoder.BUFFER_SIZE;
    ...
    // 音频编码器
    private JAVAudioEncoder mAudioEncoder;
    // 音频参数
    ...
    public void prepare(@NonNull AudioParams params) throws Exception {
        ...
        try {
            ...
            if (mBufferSize < minBufferSize / speed * 2) {
                ...
                mBufferSize = JAVAudioEncoder.BUFFER_SIZE;
            }
        ...
        // 音频编码器
        mAudioEncoder = new JAVAudioEncoder(params.getBitRate(), params.getSampleRate(), channelCount);
